...
Imputing missing values in the Occupation column of the UCI Adult Census dataset.
Detecting outliers in the age column of the Diabetes dataset.
Mitigating Diabetes age outliers using:
Trimming
Capping
Detecting outliers in the price column of the House dataset.
Mitigating House price outliers using:
Trimming
Capping
📂 Datasets Used
